...
export const env = createEnv({
  ...
  server: {
    ...
    EDIT_CLIP_ENDPOINT: z.string().optional(),
    ...
    STRIPE_LIFETIME_ACCESS: z.string(),
    BASE_URL: z.string(),
  ...
  runtimeEnv: {
    ...
    EDIT_CLIP_ENDPOINT: process.env.EDIT_CLIP_ENDPOINT,
    ...
    STRIPE_LIFETIME_ACCESS: process.env.STRIPE_LIFETIME_ACCESS,
